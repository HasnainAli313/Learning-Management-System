...
//   useEffect(() => {
//     AOS.init({
//       // AOS configuration options go here
...
//         <h1 className="text-4xl md:text-5xl font-semibold mb-4" data-aos="fade-up">
...
//         </div>
//       </section>
//       <AboutUs data-aos="fade-down" />
//      <Course data-aos="fade-up"></Course>
//      <Courses data-aos="fade-up"></Courses>
